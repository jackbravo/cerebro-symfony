...
class BaseItemForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'responsable_id'      => new sfWidgetFormInput(),
      'prueba_color'        => new sfWidgetFormDateTime(),
      'impresor_id'         => new sfWidgetFormDoctrineSelect(array('model' => 'Impresor', 'add_empty' => true)),
      'entrada_impresor'    => new sfWidgetFormDateTime(),
      'salida_impresor'     => new sfWidgetFormDateTime(),
      'mensajeria_id'       => new sfWidgetFormDoctrineSelect(array('model' => 'Mensajeria', 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'responsable_id'      => new sfValidatorInteger(array('required' => false)),
